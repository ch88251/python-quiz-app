...
('What is the primary difference between an insider threat and a shadow IT threat actor?', 'multiple_choice');
...
-- Question 2
INSERT INTO questions (question_text, question_type) VALUES
('An application creates a temporary file to save a value for later use. A malicious actor deletes this file after its created but before its subsequent use by the application. What type of vulnerability is being exploited in this situation?', 'multiple_choice');
...
-- Question 4
INSERT INTO questions (question_text, question_type) VALUES
('Which of the following terms BEST describes a situation in which a company avoids addressing known system inefficiencies or shortcuts due to time constraints, potentially leading to future rework and vulnerabilities?', 'multiple_choice');
...
-- Question 7
INSERT INTO questions (question_text, question_type) VALUES
('Kelly Innovations decides to manage its IT infrastructure within its physical location, retaining full control over its hardware, software, and data. Which of the following security implications is MOST directly associated with this approach?', 'multiple_choice');
...
-- Question 8
INSERT INTO questions (question_text, question_type) VALUES
('Kelly Innovations LLC is implementing a wireless network and needs a wireless authentication method that support multiple mechanisms for authenticating both wired and wireless users. Which protocol BEST fits their requirements?', 'multiple_choice');
...
-- Question 9
INSERT INTO questions (question_text, question_type) VALUES
('Dion Training is implementing a security device tasked with inspecting live network traffic and taking immediate action to mitigate potential threats. Which of the following security items would MOST effectively satisfy this requirement?', 'multiple_choice');
...
-- Question 11
INSERT INTO questions (question_text, question_type) VALUES
('Reed is getting a new computer from his employer, Kelly Innovations LLC. He wants to remove all his personal data from his old computer, ensuring it''s irretrievable. Which of the following methods should he use?', 'multiple_choice');
...
-- Question 12
INSERT INTO questions (question_text, question_type) VALUES
('After the IT department proposed a new software update, Kevin, a system analyst, evaluates the potential effects of this change on the system performance, user experience, and business processes. Which term BEST describes Kevin''s evaluation?', 'multiple_choice');
...
-- Question 15
INSERT INTO questions (question_text, question_type) VALUES
('Which of the following terms BEST describes the measurement used to describe a 7% possibility of hardware failure in the next year based on past statistical data?', 'multiple_choice');
...
-- Question 16
INSERT INTO questions (question_text, question_type) VALUES
('Which of the following mitigation techniques inspects and controls incoming and outgoing network traffic on a per-application basis?', 'multiple_choice');
...
-- Question 19
INSERT INTO questions (question_text, question_type) VALUES
('If a company''s server has an estimated Single Loss Expectancy (SLE) of $15,000 due to an operational failure, and the Annual Rate of Occurrence (ARO) of these failures is expected to be 0.1 times per year, what is the Annual Loss Expectancy (ALE)?', 'multiple_choice');
...
-- Question 20
INSERT INTO questions (question_text, question_type) VALUES
('Trust Us is a company that acts as a trusted entity. They issue and manage security credentials and issue digital signature wrappers for public keys for message encryption. What type of company is Trust Us?', 'multiple_choice');
...
-- Question 21
INSERT INTO questions (question_text, question_type) VALUES
('When considering data storage, which of the following BEST describes a method to capture the state of a system at a specific point in time, offering a quick recovery solution without the need for a full backup?', 'multiple_choice');
...
-- Question 22
INSERT INTO questions (question_text, question_type) VALUES
('Dion Training wants to increase the trustworthiness of its website for its clients. They are seeking a certificate that is signed and verified by a recognized external authority. What type of certificate should they pursue?', 'multiple_choice');
...
-- Question 23
INSERT INTO questions (question_text, question_type) VALUES
('Which of the following mitigation techniques can help reduce the exposure of systems to potential attacks by turning off unneeded or unwanted network communication channels?', 'multiple_choice');
...
-- Question 24
INSERT INTO questions (question_text, question_type) VALUES
('A newly established e-commerce platform needs to identify potential risks to its operations. What should be their first step in the risk management process?', 'multiple_choice');
...
-- Question 25
INSERT INTO questions (question_text, question_type) VALUES
('A small business is establishing a risk management process and wants to record and monitor identified risks. What tool should they prioritize setting up?', 'multiple_choice');
...
-- Question 26
INSERT INTO questions (question_text, question_type) VALUES
('A software development firm needs to decide how to handle the risk of potential litigation due to copyright infringement. Which risk management strategy would be most appropriate?', 'multiple_choice');
...
-- Question 27
INSERT INTO questions (question_text, question_type) VALUES
('An online retailer is conducting a Business Impact Analysis. What are they likely focusing on to ensure business continuity?', 'multiple_choice');
...
-- Question 28
INSERT INTO questions (question_text, question_type) VALUES
('A cloud service provider is evaluating the potential impacts of various risks on their service availability. What method of risk analysis should they use to assess the potential frequency of these risks?', 'multiple_choice');
...
-- Question 31
INSERT INTO questions (question_text, question_type) VALUES
('Kelly Innovations LLC has integrated a new payment gateway into their application. To ensure no potential security gaps exist, especially related to data breaches or financial data leaks, which of the following actions would be the MOST effective?', 'multiple_choice');
...
-- Question 32
INSERT INTO questions (question_text, question_type) VALUES
('Jason and Reed, both IT specialists at Kelly Innovations LLC, are tasked with ensuring the workstations'' secure baseline remains uncompromised over time. Which technique would BEST help them achieve this?', 'multiple_choice');
...
-- Question 33
INSERT INTO questions (question_text, question_type) VALUES
('Which email security standard helps prevent email spoofing by allowing domain owners to specify which mail servers are authorized to send email on their behalf?', 'multiple_choice');
...
-- Question 34
INSERT INTO questions (question_text, question_type) VALUES
('Which of the following terms refers to a major program executed by powerful entities to shift public opinion?', 'multiple_choice');
...
-- Question 36
INSERT INTO questions (question_text, question_type) VALUES
('Which of the following mitigation techniques can help prevent users from making changes to the security features of devices by applying predefined security standards?', 'multiple_choice');
...
-- Question 37
INSERT INTO questions (question_text, question_type) VALUES
('Which of the following strategies is MOST effective for organizations aiming to mitigate the risk of widespread disruptions due to a localized issue in their infrastructure?', 'multiple_choice');
...
-- Question 39
INSERT INTO questions (question_text, question_type) VALUES
('Which of the following ports should be disabled or carefully monitored to prevent unauthorized Voice over IP (VoIP) signaling, which can be an avenue for toll fraud or unauthorized call control?', 'multiple_choice');
...
-- Question 40
INSERT INTO questions (question_text, question_type) VALUES
('When integrating Cloud services with external applications, which of the following considerations is the most crucial in assessing the security risks associated with data transmission to these external service providers?', 'multiple_choice');
...
-- Question 42
INSERT INTO questions (question_text, question_type) VALUES
('Which of the following is the BEST type of backup that allows for the rapid redeployment of an OS without requiring reinstallation of third-party software, patches, and configurations?', 'multiple_choice');
...
-- Question 48
INSERT INTO questions (question_text, question_type) VALUES
('A company wants to test a new software application that was downloaded from an unknown source. The company does not want to risk infecting its network or compromising its data with malware or other threats. Which of the following techniques would be the MOST suitable for this scenario?', 'multiple_choice');
...
-- Question 49
INSERT INTO questions (question_text, question_type) VALUES
('Which of the following BEST defines the term that represents the expected number of times a risk event will occur within a one-year period?', 'multiple_choice');
...
-- Question 51
INSERT INTO questions (question_text, question_type) VALUES
('Which of the following BEST describes the primary role of an audit committee in the context of cybersecurity?', 'multiple_choice');
...
-- Question 55
INSERT INTO questions (question_text, question_type) VALUES
('Jimmy, a Chief Technology Officer, is evaluating different architecture models. His biggest concern is the ease of deployment. Which of the following factors would be MOST critical to consider from a security standpoint?', 'multiple_choice');
...
-- Question 56
INSERT INTO questions (question_text, question_type) VALUES
('Which of the following is NOT true about environmental variables?', 'multiple_choice');
...
-- Question 57
INSERT INTO questions (question_text, question_type) VALUES
('Which of the following BEST describes the primary purpose of e-discovery in digital investigations?', 'multiple_choice');
...
-- Question 58
INSERT INTO questions (question_text, question_type) VALUES
('Which of the following hardware vulnerability involves the ability to modify the software that controls the functionality of a device?', 'multiple_choice');
...
-- Question 60
INSERT INTO questions (question_text, question_type) VALUES
('A security officer at Kelly Innovations LLC is reviewing recent security incidents to assess potential threats within the organization. Two patterns of behavior have raised concerns about a possible insider threat. Which of the following are signs of potential insider threat? (Select TWO.)', 'multiple_choice');
...
-- Question 61
INSERT INTO questions (question_text, question_type) VALUES
('Which of the following techniques allows an attacker to eavesdrop on a wired network by connecting their device directly to the network cables?', 'multiple_choice');
...
-- Question 62
INSERT INTO questions (question_text, question_type) VALUES
('Which of the following statements is NOT true about the importance of continuous integration in relation to secure operations?', 'multiple_choice');
...
-- Question 63
INSERT INTO questions (question_text, question_type) VALUES
('Which term refers to the percentage of an asset''s value that is expected to be lost when a specific risk eventuates?', 'multiple_choice');
...
-- Question 64
INSERT INTO questions (question_text, question_type) VALUES
('Lexicon, an AI company, seeks to implement a security measure to systematically identify, evaluate, and prioritize potential risks to their systems and networks. Which of the following is an example of a managerial security control that would help achieve this?', 'multiple_choice');
...
-- Question 66
INSERT INTO questions (question_text, question_type) VALUES
('Which of the following is a disadvantage of agentless posture assessment in Network Access Control (NAC) solutions?', 'multiple_choice');
...
-- Question 67
INSERT INTO questions (question_text, question_type) VALUES
('Which of the following BEST describes the role of classification in effective hardware, software, and data asset management?', 'multiple_choice');
...
-- Question 68
INSERT INTO questions (question_text, question_type) VALUES
('What part of a BPA for mission essential functions provides a detailed, step-by-step description of the procedural tasks performed?', 'multiple_choice');
...
-- Question 69
INSERT INTO questions (question_text, question_type) VALUES
('In the realm of digital forensics, which activity is a primary focus during the preservation phase?', 'multiple_choice');
...
-- Question 71
INSERT INTO questions (question_text, question_type) VALUES
('Which of the following statements is NOT true concerning the significance of NetFlow?', 'multiple_choice');
...
-- Question 72
INSERT INTO questions (question_text, question_type) VALUES
('As a security analyst, you are reviewing application logs while investigating a suspected breach. Which of the following pieces of information is NOT typically documented in the application log data?', 'multiple_choice');
...
-- Question 73
INSERT INTO questions (question_text, question_type) VALUES
('Which of the following solutions should a data center implement to guarantee customer data remains unreadable in the event of a physical server compromise?', 'multiple_choice');
...
-- Question 77
INSERT INTO questions (question_text, question_type) VALUES
('Which of the following approaches ensures real-time or near-real-time duplication of data to a secondary location for purposes like high availability, disaster recovery, and load balancing?', 'multiple_choice');
...
-- Question 78
INSERT INTO questions (question_text, question_type) VALUES
('Which technique, when considering high availability, involves distributing network or application traffic across a number of servers to enhance the performance and reliability of applications?', 'multiple_choice');
